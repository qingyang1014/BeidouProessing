...
settings.msToProcess           = 42000;%42000;        %[ms]
...
% based only.
settings.skipNumberOfBytes     = 90e6;   %1*16e6;

% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName              = '../beidoudata/usbdataBD2.bin' ;%'../B20140325/usbdata1.dat';

% Data type used to store one sample

settings.dataType              = 'int8'; %'cl';  %little endian  character type
